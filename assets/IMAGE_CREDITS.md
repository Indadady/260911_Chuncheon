# Image Credits — 260911_Chuncheon

| File | Source | License |
|------|--------|---------|
| hero.jpg | [Commons: File:Chuncheon-01.jpg](https://commons.wikimedia.org/wiki/File:Chuncheon-01.jpg) | CC / Wikimedia |
...
| day1-samaksan.jpg | [Commons: File:삼악산 케이블카.jpg](https://commons.wikimedia.org/wiki/File:%EC%82%BC%EC%95%85%EC%82%B0_%EC%BC%80%EC%9D%B4%EB%B8%94%EC%B9%B4.jpg) | CC BY-SA |
| logo-senior.png | 담당자 제공 (대한노인회 공식 로고) | 제공 자료 |

`og-thumb.jpg`는 9월 초가을 분위기(맑은 하늘·호반)의 춘천 대표 명소 **소양강 스카이워크**로 설정했습니다.  
`hero.jpg`(소양2교·호반)와 서로 다른 구도입니다.  
식사(중식·석식) 관련 이미지는 일정 미반영으로 제외했습니다.

All sightseeing images downloaded via Wikimedia Commons `Special:FilePath` and hosted locally under `assets/images/`.
